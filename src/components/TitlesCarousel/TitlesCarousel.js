...
export const MovieCarousel = ({ renderOn, movies, id }) => {
    const template = `
    <div class="wrapper">
...
const carousel = document.getElementById(`carousel-${id}`),
  content = document.getElementById(`carousel_content-${id}`),
  next = document.getElementById(`carousel_next-${id}`),
  prev = document.getElementById(`carousel_prev-${id}`);
